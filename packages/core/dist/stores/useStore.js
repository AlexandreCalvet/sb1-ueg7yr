    ...
    return {
        ...
        initializeSubscriptions: () => {
            ...
            try {
                ...
                const mealPlansQuery = query(collection(db, 'mealPlans'));
                ...
                const groceryListQuery = query(collection(db, 'groceryItems'));
        ...
        updateGroceryList: async () => {
            ...
            try {
                ...
                const existingItemsQuery = query(collection(db, 'groceryItems'));
